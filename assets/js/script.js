...
var deleteTask = function (taskId) {
  ...
  for (var i = 0; i < tasks.length; i++) {
    // if task.id does not match the value of taskId, let's keep that task and push it into the new array
    if (tasks[i].id !== parseInt(taskId)) {
      updatedTaskArr.push(tasks[i]);
    }
  }

  // reassign tasks arrat to be the same as updatedTasksArr
